...
if __name__ == '__main__':
    ...
    info = {}
    filename = args.inputfile[args.inputfile.find(args.prodcampaign):].replace('/crab_output','')
    info[filename] = {}
    ...
    df = r.RDataFrame('taus', args.inputfile, ["genLepton_index", "genLepton_kind", "tau_pt", "tau_eta"])
